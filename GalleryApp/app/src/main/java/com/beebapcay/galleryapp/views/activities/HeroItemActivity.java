...
public class HeroItemActivity extends AppCompatActivity {
	...
	public void doInitialization() {
		...
		mHeroItemViewModel.getLiveIsFavourite().setValue(mDataItem.isFavourite());
...
//			bundle.putParcelable(ExtraIntentKey.EXTRA_HERO_ITEM_DATA, mBundle.getParcelable(ExtraIntentKey.EXTRA_HERO_ITEM_DATA));
			getSupportFragmentManager().beginTransaction()
					...
					.add(R.id.view_fragment_container, HeroPictureFragment.class, null)
					.commit();
		}
...
//			bundle.putParcelable(ExtraIntentKey.EXTRA_HERO_ITEM_DATA, mBundle.getParcelable(ExtraIntentKey.EXTRA_HERO_ITEM_DATA));
			getSupportFragmentManager().beginTransaction()
					.setReorderingAllowed(true)
					.add(R.id.view_fragment_container, HeroVideoFragment.class, null)
					.commit();
		}
